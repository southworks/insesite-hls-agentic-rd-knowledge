# Aggregate trial record use

Policy RAG evidence card

- Document ID: `HLS-TRIAL-300`
- Category: `policy_rag`
- Source entity: `08_policy_rag/HLS-TRIAL-300.json`

## Policy Rule

| Field | Value |
| --- | --- |
| Policy ID | HLS-TRIAL-300 |
| Policy ref | HLS-TRIAL-300 |
...
| Source refs | CLINICALTRIALS_GOV_DATA_API; AACT_HOME |
...
| Privacy posture |  |
| Raw source trace | 00_raw/_corpus/json/policies/CLINICALTRIALS_GOV_DATA_API/source_record.json; 00_raw/_corpus/json/policies/AACT_HOME/source_record.json |
