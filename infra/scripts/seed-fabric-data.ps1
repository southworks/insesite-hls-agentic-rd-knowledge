...
if ([string]::IsNullOrWhiteSpace($envRepositoryArchiveUrl)) {
    $envRepositoryArchiveUrl = 'https://github.com/southworks/insesite-hls-agentic-rd-knowledge/archive/refs/heads/main.zip'
}
...
Write-Host '=== Fabric Data Seed (HLS) ==='
...
$workDir = Join-Path (Get-ScratchRoot) 'hls-fabric-seed'
